    ...
    public async Task PrintReceptionActAsync(long orderId, Window parent)
    {
        try
        {
            ...
            using (var document = WordprocessingDocument.Create(path, WordprocessingDocumentType.Document))
            {
                ...
                AddLine("Порядок оплаты:", bold: true);
                ...
                AddLine("Сроки ремонта", bold: true);
                ...
                AddLine("Ответственность сервиса", bold: true);
                ...
                AddLine("Действия клиента", bold: true);
                ...
                AddLine("Хранение и выдача", bold: true);
                ...
                AddLine("Форс-мажор и отказ от ремонта", bold: true);
                ...
                AddLine("Разрешение споров", bold: true);
                ...
                AddLine("");
                AddLine("С условиями приема в ремонт ознакомлен, согласен.", bold: true);
                AddLine("Предупрежден о необходимости сделать резервную копию данных.", bold: true);
                AddLine("Устройство сдаю без учетной записи.", bold: true);
